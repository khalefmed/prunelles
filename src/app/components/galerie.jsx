...
export const Galerie = () => {
    ...
    return (
        <section id='services' className='overflow-hidden max-w-screen justify-center align-center items-center p-28 flex flex-col gap-16 max-lg:p-16 max-sm:px-0 max-sm:8'>
            { i18n.language == "ar" 
            ? 
            ...
            <div className='flex  justify-center align-center items-center w-full rounded-xl'>
                <ImageSwiper/>
            </div>
